...
class wide_resnet50_2(nn.Module):
    def __init__(self,pretrained: bool = False, progress: bool = True,eval=True, **kwargs: Any):
        super().__init__()
        kwargs['width_per_group'] = 64 * 2
        self.Module= _resnet('wide_resnet50_2', Bottleneck, [3, 4, 6, 3],pretrained, progress, **kwargs)
        if eval:
            self.Module.eval()
